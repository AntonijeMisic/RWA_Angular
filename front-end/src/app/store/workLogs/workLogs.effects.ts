...
export class WorkLogsEffects {
    ...
    loadCurrentWeek$ = createEffect(() =>
        ...
        exhaustMap(action =>
            ...
            catchError(error => of(WorkLogsActions.loadCurrentWeekLogsFailure({ error })))
            )
        )
        )
    );
    ...
    loadWorkLogForDate$ = createEffect(() =>
        ...
        exhaustMap(({ userId, date }) =>
            ...
            catchError(error => of(WorkLogsActions.loadWorkLogForDateFailure({ error })))
            )
        )
        )
    );
    ...
    resumeWork$ = createEffect(() =>
        ...
        exhaustMap(action =>
            this.workLogService.resumeWork(action.userId).pipe(
                    ...
                    catchError(error => of(WorkLogsActions.resumeWorkFailure({ error })))
                )
            )
        )
    );
